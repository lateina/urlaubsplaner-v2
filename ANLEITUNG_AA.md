...
**Link:** [https://lateina.github.io/urlaubsplaner-v2/assistenz.html](https://lateina.github.io/urlaubsplaner-v2/assistenz.html)

1.  **Planer-Code (Master Key):** Geben Sie den vom Administrator bereitgestellten Assistenten-Code ein. Dieser wird gespeichert und muss normalerweise nur einmal pro Gerät eingegeben werden.
...
### PO-Eintragung (Personalorganisation)
Nach der finalen Genehmigung im Urlaubsplaner wird Ihr Urlaub in das offizielle Dienstplansystem (PO) übertragen. Sobald dieser Schritt durch das Sekretariat abgeschlossen wurde, erscheint bei Ihrem Antrag ein grüner Haken mit dem Status: *"In PO eingetragen"*.
